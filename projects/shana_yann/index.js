...
(async () => {
  ...
  playAudio("./projects/shana_yann/assets/rocket_sound.mp3");
  ...
  await page.addStyleTag({
    path: "./projects/shana_yann/gmap.style.css",
  });
  await page.addScriptTag({ path: "./projects/shana_yann/gmap.web.js" });
  ...
  while (true) {
    ...
    term.slowTyping(reason + "\n", {
      ...
      generate_speech({ text: reason, voice: "shimmer" });
    ...
    await Promise.all([
      ...
      generate_speech({ text: building, voice: "shimmer" }),
    ]);
