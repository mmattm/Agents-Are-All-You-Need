...
(async () => {
  ...
  while (true) {
    ...
    await page.goto("https://whereby.com", { waitUntil: "domcontentloaded" });

    await page.click(".start-call-button");
    await page.type(".room-name-input", "your-room-name");
    await page.click(".join-room-button");
    await page.waitForSelector(".call-active-indicator");
    await page.screenshot({ path: "whereby_call_screenshot.png", fullPage: true });
